...
router.post('/create', authenticate, upload.single('profileImage'), profileController.createProfile);
...
router.put('/update', authenticate, upload.single('profileImage'), profileController.updateProfile);
